...
// TODO 17. ЗАДАЧА. ИМЕНА ПОЛЬЗОВАТЕЛЕЙ
...
// TODO 20. ФИЛЬТРАЦИЯ УНИКАЛЬНЫХ ЭЛЕМЕНТОВ
...
// TODO 21. МЕТОД FILTER() И МАССИВ ОБЪЕКТОВ
...
// TODO 22. ЗАДАЧА. ПОЛЬЗОВАТЕЛИ С ЦВЕТОМ ГЛАЗ
...
// console.log(`Result:`, getUsersWithEyeColor(users, 'green'));

// TODO 23. ЗАДАЧА. ПОЛЬЗОВАТЕЛИ В ВОЗРАСТНОЙ КАТЕГОРИИ
...
// console.table(getUsersWithAge(users, 20, 30)); // Ross Vazquez, Elma Head и Carey Barr

// TODO 24. ЗАДАЧА. ПОЛЬЗОВАТЕЛИ С ДРУГОМ
...
//* v2
// const getFriends = users => {
//   const allFriend = users.flatMap(element => element.friends);
//   const uniqueFriends = allFriend.filter((friend, index, array) => array.indexOf(friend) === index);

//   return uniqueFriends;
// };

// console.log(`Result:`, getFriends(users));
...
// TODO 26. ЗАДАЧА. АКТИВНЫЕ ПОЛЬЗОВАТЕЛИ
...
// const getActiveUsers = users => users.filter(status => status.isActive);

// console.log(`Result:`, getActiveUsers(users));
// Sharlene Bush, Elma Head, Carey Barr и Sheree Anthony

// TODO 27. ЗАДАЧА. НЕАКТИВНЫЕ ПОЛЬЗОВАТЕЛИ
...
// const getInactiveUsers = users => users.filter(status => !status.isActive);
...
// TODO 29. ЗАДАЧА. ПОЛЬЗОВАТЕЛЬ С ПОЧТОЙ
...
// console.log(`Result:`, getUserWithEmail(users, 'shereeanthony@kog.com'));
...
// TODO 33. ЗАДАЧА. ЕСТЬ ЛИ АКТИВНЫЕ ПОЛЬЗОВАТЕЛИ
...
// TODO 35. МЕТОД REDUCE() И МАССИВ ОБЪЕКТОВ
...
//   (previousValue, number) => previousValue + number.playtime / number.gamesPlayed,
//   0
// );

// console.log(totalAveragePlaytimePerGame);

// TODO 36. ЗАДАЧА. ОБЩИЙ БАЛАНС ПОЛЬЗОВАТЕЛЕЙ
...
// console.log(`Result:`, calculateTotalBalance(users));

// TODO 37. ЗАДАЧА. ОБЩЕЕ КОЛИЧЕСТВО ДРУЗЕЙ
...
// console.log(`Result:`, getTotalFriendCount(users));
...
// TODO 39. СВОЙ ПОРЯДОК СОРТИРОВКИ ЧИСЕЛ
...
// console.log(`Ascending:`, ascendingReleaseDates, `Ascending:`, descendingReleaseDates);

// TODO 40. СВОЙ ПОРЯДОК СОРТИРОВКИ СТРОК
...
// console.log(`InAlphabe:`, authorsInAlphabetOrder, `InReverse:`, authorsInReversedOrder);

// TODO 41. СОРТИРОВКА ОБЪЕКТОВ
/* Дополни код так, чтобы:

1. В переменной sortedByAuthorName получился массив книг отсортированный по имени автора в алфавитном порядке.
2. В переменной sortedByReversedAuthorName получился массив книг отсортированный по имени автора в обратном алфавитном порядке.
...
// TODO 43. ЗАДАЧА. СОРТИРОВКА ПО КОЛИЧЕСТВУ ДРУЗЕЙ
...
// TODO 44. ЗАДАЧА. СОРТИРОВКА ПО ИМЕНИ
...
// TODO 45. ЦЕПОЧКИ МЕТОДОВ (ЧЕЙНИНГ, CHAINING)
...
// TODO 46. ЗАДАЧА. ПОЛЬЗОВАТЕЛИ И ДРУЗЬЯ
